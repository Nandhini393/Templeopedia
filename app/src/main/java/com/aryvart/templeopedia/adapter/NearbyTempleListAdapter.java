 ...
 */
public class NearbyTempleListAdapter extends BaseAdapter {
    ...
    public NearbyTempleListAdapter(Context cont, ArrayList<TempleListBean> providerBean, TempleList list) {
        this.context = cont;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.nearby_temple_content, parent, false);

                // get layout from mobile.xml
                view.txt_temple_name = (TextView) convertView.findViewById(R.id.txt_near_temple_name);
                view.img_temple_image = (ImageView) convertView.findViewById(R.id.img_near_temple_image);
